...
function [u_k,Theta_k, P_k, K]  = DMAC_compute_control(xi_k,q_k, xi_km1,u_km1, dmac, Theta_km1, P_km1, K)
...
% if k>1
    % [Theta_k, P_k, K] = DMAC_update(phi_km1, xi_k, Theta_km1, P_km1, K, dmac);
% else
%     P_k = P_km1;
%     Theta_k = Theta_km1;
% end
