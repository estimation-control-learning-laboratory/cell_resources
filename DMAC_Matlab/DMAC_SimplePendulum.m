...
for k = 1:N
    ...
    x = PendulumDynamics(x, m, g, l, dt, u);
...
ylabel('$\theta_k$', 'Interpreter', 'latex', 'fontsize', 22)
...
ylabel('$\dot{\theta}_k$', 'Interpreter', 'latex', 'fontsize', 22)
axis tight
grid on
...
% print(gcf,'-dpng','Figures/Pendulum/png/Pendulum_DMAC_FSFI')
% print(gcf,'-depsc','Figures/Pendulum/eps/Pendulum_DMAC_FSFI')
...
% print(gcf,'-dpng','Figures/Pendulum/png/Pendulum_DMAC_FSFI_zk')
% print(gcf,'-depsc','Figures/Pendulum/eps/Pendulum_DMAC_FSFI_zk')
...
% here
X_Aug_l_3 = X_Aug;
filename = 'Pendulum_System_Sensitivity_Vars.mat';
variables = 'X_Aug_l_3';  
% save(filename,variables) 
% save(filename,variables,"-append") 


function x_next = PendulumDynamics(x, m, g, l, dt, tau)
tspan = [0 dt];
f = @(t, x) [x(2); -(g/l)*sin(x(1)) + tau/(m*l^2)];
